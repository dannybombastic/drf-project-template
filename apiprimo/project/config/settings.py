"""
Django settings for project apiprimo.
...
SECRET_KEY = os.getenv('SECRET_KEY', 'pfxp!&_0x-n1hkh*ix%=ju&^kjp1@j04=$35ta740xu*xnhsx&')
...
APP_VERSION = '1.0.0'
APP_NAME = 'apiprimo'
APP_DESCRIPTION = 'A RESTfull API for project apiprimo'
